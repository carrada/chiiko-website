...
import { verazDetailsNl } from "./veraz/details.i18n";
...
export const projectContent = {
  page: {
    title: "Projecten",
    description:
      "Hier kun je onze laatste projecten en case studies ontdekken.",
    seoTitle: projectsPageSeo.nl.seoTitle,
    seoDescription: projectsPageSeo.nl.seoDescription,
  ...
  items: {
    veraz: mergeProjectItemSeo("veraz", "nl", verazItems.nl),
    eamx: {
      title: "EAMX",
      description:
        "Architectuur en structurele precisie naar het digitale vlak gebracht.",
      services:
    ...
    compufest: {
      title: "Compufest [1]",
      description:
        "Het grootste studentencomputing- en programmeer-event van de UNAM.",
    ...
    emicarrada: {
      ...
      description:
        "Het kruispunt van software-engineering en digitaal vakmanschap.",
    ...
    alancrespo_ai: {
      title: "Alan Crespo",
      description:
        "Van academie naar wereldwijde leiderschap in Artificial Intelligence (Deep Tech).",
      services:
        "Visual Identity Design, B2B-positioningstrategie, Content Engineering.",
      client: "Alan Crespo Murillo.",
    },
  },
  details: {
    veraz: verazDetailsNl,
    eamx: {
      tagline:
