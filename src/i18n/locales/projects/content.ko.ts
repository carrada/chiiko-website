...
export const projectContent = {
  ...
  items: {
    ...
    eamx: {
      ...
      services:
        "디지털 전략, 인터랙션 디자인, 고급 프론트엔드 개발.",
      client: "EAMX Arquitectos.",
    },
    compufest: {
      title: "Compufest [1]",
      description: "UNAM 최대 규모의 학생 컴퓨팅·프로그래밍 행사.",
      services: "디지털 전략, UI/UX 디자인, 웹 개발.",
      client: "Compufest / UNAM 학생 커뮤니티.",
    },
    emicarrada: {
      title: "emicarrada.com",
      description: "소프트웨어 엔지니어링과 디지털 크래프트의 교차점.",
      services: "아트 디렉션, 고급 프론트엔드 개발, WebGL 3D.",
      client: "Cristopher Carrada.",
    },
    alancrespo_ai: {
      title: "Alan Crespo",
      description: "학계에서 인공지능(Deep Tech) 글로벌 리더십으로.",
      services:
        "비주얼 아이덴티티 디자인, B2B 포지셔닝 전략, 콘텐츠 엔지니어링.",
  ...
  details: {
    ...
    eamx: {
      ...
      impactAttribution: "프로젝트 디렉션, EAMX",
    ...
    compufest: {
      ...
      impactAttribution: "조직 팀, Compufest",
    } satisfies ProjectDetailContent,
    ...
    emicarrada: {
      ...
      impactAttribution:
        "Cristopher Carrada, 소프트웨어 개발자 및 Chiiko 창립자",
    } satisfies ProjectDetailContent,
