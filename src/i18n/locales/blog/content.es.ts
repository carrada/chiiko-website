...
export const blogPageContent: BlogPageContent = {
  ...
  title: "Blog",
  description: "Reflexiones del estudio Chiikö sobre diseño, tecnología y cultura digital.",
  ...
  posts: [
    {
      ...
      excerpt: "Cómo diseñamos y construimos Veraz — plataforma de noticias con design system tokenizado, globo 3D y lectura bilingüe donde la IA nunca bloquea la noticia.",
      category: "Proyectos",
      body: body([
