...
export const NavBody = ({ children, className, visible }: NavBodyProps) => {
  return (
    <motion.div
      ...
      className={cn(
        "relative z-60 flex w-auto min-w-[400px] flex-row items-center justify-center gap-6 rounded-full bg-transparent px-12 py-5 overflow-visible dark:bg-transparent",
...
export const NavItems = ({ items, className, onItemClick }: NavItemsProps) => {
  ...
  return (
    <motion.div
      ...
      className={cn(
        "flex flex-row items-center justify-start gap-4 text-base font-medium text-zinc-600 transition duration-200 hover:text-zinc-800",
        className,
      )}
    >
      {items.map((item, idx) => (
